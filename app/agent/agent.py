        ...
        while True:
            try:
                ...
                for chunk in self.agent.stream({"messages": user_input}, configuration):
                    ...
                    #         messages = chunk["post_model_hook"]["messages"]
                    #         if messages != [] and isinstance(messages[-1], ToolMessage):
                    #             if (
                    #                 hasattr(messages[-1], "invalid")
                    #                 and messages[-1].invalid
                    #             ):
                    #                 self.console.print("─" * 30, style="red")
                    #                 self.console.print(
                    #                     "⚠️  [red]Invalid tool call request generated by the agent.[/red]"
                    #                 )
                    #                 self.console.print(
                    #                     "⚠️  [red]Agent now thinking on how to solve the issue...[/red]"
                    #                 )
                    #                 self.console.print("─" * 30, style="red")
